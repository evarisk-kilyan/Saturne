...
/**
 * \file    admin/public_inteface.php
 * \ingroup saturne
 * \brief   Saturne public interface
 */
...
$contextpage = GETPOST('contextpage', 'aZ') ? GETPOST('contextpage', 'aZ') : 'pulicinterfacelist'; // To manage different context of search
...
if (isModEnabled('categorie')) {
    $search_category_array = GETPOST('search_category_publicinterface_list', 'array');
}
...
$hookmanager->initHooks(['publicinterfaceadmin', 'saturneadmin']); // Note that conf->hooks_modules contains array
...
if (empty($reshook)) {
    ...
    // Mass actions.
    /*$objectclass = 'PublicInterface';
    $objectlabel = 'PublicInterface';
...
$title    = $langs->trans('PublicInterfaceList');
...
if (isModEnabled('categorie')) {
    $sql .= Categorie::getFilterSelectQuery('publicinterface', 't.rowid', $search_category_array);
}
...
$newcardbutton .= dolGetButtonTitle($langs->trans('New'), '', 'fa fa-plus-circle', dol_buildpath('/saturne/view/publicinterface/publicinterface_card.php', 1) . '?action=create', '', $permissiontoadd);

print_barre_liste($title, $page, $_SERVER['PHP_SELF'], $param, $sortfield, $sortorder, $massactionbutton, $num, $nbTotalOfRecords, 'object_' . $object->picto, 0, $newcardbutton, '', $limit, 0, 0, 1);

//$topicmail = 'SendPublicInterfaceRef';
//$modelmail = 'publicinterface';
//$objecttmp = new SaturnePublicInterface($db);
...
//    $moreforfilter .= $formcategory->getFilterBox('publicinterface', $search_category_array);
//}
...
//
 //Initialize technical objects
//$saturnePublicInterface = new SaturnePublicInterface($db);
//
 //Initialize view objects
//$form = new Form($db);
//
...
//print dol_get_fiche_head($head, 'publicInterface', $title, -1, $moduleNameLowerCase . '_color@' . $moduleNameLowerCase);
//
//print load_fiche_titre($langs->trans('Configs', dol_strtolower($langs->trans('PublicInterface'))), '', '');
//
//
//print '<table class="noborder centpercent">';
//print '<tr class="liste_titre">';
//print '<td>' . $langs->trans('FromURL') . '</td>';
//print '<td>' . $langs->trans('Template') . '</td>';
//print '<td class="center">' . $langs->trans('Action') . '</td>';
//print '</tr>';
//
//$publicIntefaces = $saturnePublicInterface->fetchAll();
//foreach ($publicIntefaces as $publicInterface) {
//    print '<tr class="oddeven">';
//    print '<td>' . $publicInterface->url . '</td>';
//    print '<td>' . $publicInterface->template . '</td>';
//    print '<td class="center">';
//}
//
//print '<form method="post" action="' . $_SERVER['PHP_SELF'] . '?module_name=' . $moduleName . '&action=add">';
//print '<tr class="oddeven"><td>';
//print '<input type="text" class="marginrightonly minwidth300 maxwidthonsmartphone" name="url" placeholder="' . $langs->trans('FromURL') . '" value="' . $url . '" required>';
//print $form->textwithpicto('', $langs->trans('PublicInterfaceUrlHelp'));
//print '</td><td>';
//print '<input type="text" name="template" class="marginrightonly minwidth300 maxwidthonsmartphone" placeholder="' . $langs->trans('Template') . '"  value="' . $template . '" required>';
//print $form->textwithpicto('', $langs->trans('PublicInterfaceTemplateHelp'));
